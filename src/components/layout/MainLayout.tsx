    ...
    <div className="min-h-screen bg-gradient-primary relative overflow-hidden">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Skin Pass</span>
              <img className="h-8 w-auto" src="/logo.svg" alt="Skin Pass" />
            </a>
          </div>
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-background-dark px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/25">
                <div className="py-6">
                  <a
                    href="#"
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-primary/20"
                  >
                    Launch App
                  </a>
                </div>
      ...
      <main>
        <motion.div
          ...
          className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 lg:px-8"
        >
